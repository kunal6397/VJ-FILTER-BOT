...
URL = "https://average-rivi-neonghost-c19ddb03.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://average-rivi-neonghost-c19ddb03.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://average-rivi-neonghost-c19ddb03.koyeb.app/".format(FQDN)
else:
    URL = "https://average-rivi-neonghost-c19ddb03.koyeb.app/".format(FQDN)
